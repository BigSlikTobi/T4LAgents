...
def load_instruction_from_file(
    ...
    try:
        # Construct path relative to the current script file, including instructions directory
        filepath = os.path.join(os.path.dirname(__file__), "instructions", filename)
